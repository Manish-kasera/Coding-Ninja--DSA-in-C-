...
You are given with an integer k and an array of integers that contain numbers in 
random order. Write a program to find k smallest numbers from given array. 
...
Output Format :
The first and only line of output print k smallest elements. The elements in the 
