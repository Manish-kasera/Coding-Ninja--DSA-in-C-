...
then you should return the same linked list without any change. And if position 'pos' is equal to length of input linked list, then insert the node at the last position.
Input format:
...
Node* insertNode(Node *head, int i, int data) {
	...
	// Node that just before the index
	Node *prev = head;
	...
	while(pos < i)
	{
        ...
        // if our prev is NULL (it's means we are going out of LL)
		if(prev == NULL)
		  return head;
